...
<script type="text/javascript">
	...
	function check(){
		...
		if(newPassword.length != 6){
			errorStr += "新密码必须为6位!<br>";
		}
		if(againPassword != newPassword){
			errorStr += "验证密码必须与新密码一致!<br>";
		}
		
		if(errorStr != ""){
			$("span#errorArea").html(errorStr);
			$("tr#errorTr").css("display", "block");
		}else{
			$("tr#errorTr").css("display", "none");
			return true;
			//$.post("changePassword.action",{password: yPassowrd, fPassword: fPassword});
		}
		return false;
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<form action="changePassword.action" method="post" onsubmit="return check();">
	<tr>
            						...
            						<table width="100%" border="0" cellspacing="0" cellpadding="0">
              							<tr>
                							...
                							<td width="95%" class="STYLE1">
                								<span class="STYLE3">你当前的位置</span>：[员工信息]-[修改密码]
                							</td>
              							</tr>
            						</table>
            					</td>
        				...
        				<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          					...
          					<!--
           					...
           					<tr>
            					...
            					<td height="20" width="200" bgcolor="#FFFFFF"><div align="left" ><span class="STYLE1">&nbsp;<input type="password" name="password" id = "password" size="10"></span></div>
            					</td>
            				...
            				<td height="20" bgcolor="#FFFFFF"><div align="left"><span class="STYLE1">&nbsp;<input type="password" name="newPassword" id="newPassword" size="10">&nbsp;请输入6位新密码，包括字母或数字</span></div>
            				</td>
          				...
          				<tr>
            				...
            				<td height="20" bgcolor="#FFFFFF"><div align="left"><span class="STYLE1">&nbsp;<input type="password" name="againPassword" id="againPassword" size="10">&nbsp;请再输入一次新密码</span></div></td>
          				...
          				<tr id="errorTr" style="display: none">
            				...
            				<td height="20" bgcolor="#FFFFFF"><div align="left"><span class="STYLE1" id="errorArea"></span></div></td>
    	...
    	<td height="35" background="../images/tab_19.gif">
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			...
        			<td>
            			<input type="submit" value="保存" onclick="this.form.onsubmit();"/>
            		</td>
