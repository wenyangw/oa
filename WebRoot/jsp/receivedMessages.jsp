...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[公文管理]-[接收文件]</td>
              </tr>
            </table></td>
            <td width="54%">
            <!-- 
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
            ...
            <td width="3%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center">
             ...
             -->
            <td width="20%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">主题</span></div></td>
            <td width="20%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">发送人</span></div></td>
            <td width="20%" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">发送时间</span></div></td>
            <!-- 
            <td width="15%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF" class="STYLE1"><div align="center">基本操作</div></td>
             -->
          </tr>
          <c:if test="${!empty pm.list}">
          <c:forEach items="${pm.list}" var="message">
          ...
          <!-- 
            <td height="20" bgcolor="#FFFFFF"><div align="center">
             ...
             -->
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1"><a href="showMessage.action?id=${message.id}">${message.subject}</a></span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${message.sender.name}</span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${message.sendedTime}</span></div></td>
            <!-- 
  ...
  <tr>
    <td height="35" background="../images/tab_19.gif">
     <!-- 可以在这里插入分页导航条 -->
	<pg:pager url="showMessages.action" items="${pm.total}" export="currentPageNumber=pageNumber">
<%--	<pg:param name="id"/>--%>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
