...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[公文管理]-[发出文件]</td>
              </tr>
            </table></td>
            <td width="54%">
            <!-- 
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
            ...
            <td width="20%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">接收人</span></div></td>
          ...
          <!-- 
            ...
            <td bgcolor="#FFFFFF"><div align="center" class="receivers"><span class="STYLE1">
            ${message.recPersons}
            </span></div></td>
  ...
  <tr>
    <td height="35" background="../images/tab_19.gif">
     <!-- 可以在这里插入分页导航条 -->
	<pg:pager url="sendedMessages.action" items="${pm.total}" export="currentPageNumber=pageNumber">
<%--	<pg:param name="id"/> --%>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
