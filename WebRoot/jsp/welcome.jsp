        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
            	...
            	<td width="46%" valign="middle">
            	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td width="95%" class="STYLE1"><span class="STYLE3">欢迎使用信息管理系统</span></td>
                    </tr>
                  </table>
                </td>
                <td width="54%">
        ...
        <tr>
          ...
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
              ...
              -->
              <tr>
               	<td width="50%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">系统说明</span></div></td>
               	<td width="50%" height="22" background="../images/bg1.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">更新说明</span></div></td>
              </tr>
              <tr>
                <!-- 
          	  ...
          	  <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              		<div align="left">
               		** 用户只能查看自己已发送或他人发送给自己的文件
              		</div>
            		</div>
            	</td>
            	<td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              		<div align="left">
               		** 对系统运行时出现的错误请谅解并请及时通知管理员 
              		</div>
            		</div>
            	</td>
          	  </tr>
          	  ...
          	  <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              		<div align="left">
               		** 用户首次登录后请及时修改密码并更新个人信息
              		</div>
            		</div>
            	</td>
            	<td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              		<div align="left">
               		** 对本系统的各种功能及操作方面有何建议请通过本系统与管理员沟通
              		</div>
            		</div>
            	</td>
          	  </tr>
          	  ...
          	  <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              		<div align="left">
               		<font color="red">** 在使用平台发送文件时，请必须填写"主题"</font>
              		</div>
            		</div>
            	</td>
            	<td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
